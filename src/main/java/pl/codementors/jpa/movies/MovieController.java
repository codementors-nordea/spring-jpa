...
import pl.codementors.jpa.movies.model.MovieOverview;
import pl.codementors.jpa.movies.model.Genre;
import pl.codementors.jpa.movies.model.Movie;
import pl.codementors.jpa.movies.model.MovieUpdateRequest;
...
public class MovieController {
    ...
    public Page<Movie> getPositions(MovieSearch search, Pageable pageable) {
        return movieRepository.findAll(search.asSpecification(), pageable);
    }
